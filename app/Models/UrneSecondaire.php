 ...
 */
class UrneSecondaire extends BaseModel implements Auditable
{
    ...
    {
        return $this->belongsToMany(Participant::class, 'participant_urne_secondaire', 'urne_secondaire_id', 'participant_id')
            ->distinct();
    }
