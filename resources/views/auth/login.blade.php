...
<head>
    ...
    <title>{{ config('app.name', 'Admin-IT') }} | Log in</title>
...
<div class="login-box">
    <div class="login-logo">
        <a href="/">{{ config('app.name', 'Admin-IT') }}</a>
    </div>
    <!-- /.login-logo -->
    <div class="card">
        <div class="card-body login-card-body">
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="input-group mb-3">
                    <input id="email" placeholder="Login / Email" type="text" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
